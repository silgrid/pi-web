...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.pinnedGroupCollapse": "隐藏 {path} 的会话",
    "sidebar.pinnedGroupNoSessions": "暂无会话",
    "sidebar.addNew": "新增",
    "sidebar.renameDirectory": "重命名目录",
    ...
    "directoryPicker.entriesTitle": "侧边栏目录列表",
    "directoryPicker.noEntries": "尚未添加目录",
    "directoryPicker.entryName": "显示名称",
    "directoryPicker.renameEntry": "重命名",
    "directoryPicker.removeEntry": "从列表移除",
    "directoryPicker.cannotRemoveLastEntry": "无法移除列表中的最后一个目录",
    "directoryPicker.renamePathRequired": "请输入目录路径",
    "directoryPicker.renamePathDuplicate": "此路径的目录已在列表中",
    "directoryPicker.entryPath": "目录路径",
    "directoryPicker.newFolder": "新建文件夹",
    "directoryPicker.folderName": "文件夹名称",
    "directoryPicker.createFolder": "创建",
    "directoryPicker.mkdirConflict": "同名文件夹已存在",
    "directoryPicker.createFileConflict": "已存在同名文件",
    "directoryPicker.newFile": "新建文件",
    "directoryPicker.fileName": "文件名",
    "directoryPicker.fileCreated": "文件已创建",
    "directoryPicker.showHidden": "显示隐藏目录",
    "directoryPicker.pinDirectory": "固定",
    "directoryPicker.rowNew": "新建",
    "directoryPicker.rowNewFolderChoice": "文件夹",
    "directoryPicker.rowNewFileChoice": "文件",
    "directoryPicker.validation.required": "请输入文件名",
    "directoryPicker.validation.invalid": "文件名无效",
    "directoryPicker.validation.dotSegment": "文件名不能为 \".\" 或 \"..\"",
    "directoryPicker.validation.pathSeparator": "文件名不能包含路径",
    "directoryPicker.validation.tooLong": "文件名过长",
    ...
    "directoryPicker.fsManage.notDirectory": "只能重命名或删除目录",
    "directoryPicker.fsManage.outsideRegistrationPrefix": "此目录受保护，无法重命名或删除",
    "directoryPicker.fsManage.pathInUse": "此目录正被代理会话使用",
    "directoryPicker.fsManage.confirmMismatch": "输入的名称与目录名称不一致",
    "directoryPicker.fsManage.targetExists": "已存在同名目录",
    "directoryPicker.fsManage.ioFailure": "文件系统操作失败",
    "sidebar.cancel": "取消",
    ...
    "sidebar.explorerEmpty": "添加或选择目录以浏览其文件",
    "sidebar.explorerSectionExpand": "显示 {path} 的文件",
    "sidebar.explorerSectionCollapse": "隐藏 {path} 的文件",
    "sidebar.loading": "加载中...",
    ...
    "files.showBuildOutputs": "显示构建产物",
    "files.showBuildOutputsHint": "在文件浏览器中显示 build/dist 构建产物目录",
    ...
    "chat.filePickerUnsupportedTitle": "当前环境不支持文件选择",
    "chat.filePickerUnsupportedBody": "点击后没有弹出文件选择器。当前应用外壳的 WebView 很可能缺少原生文件选择桥——请改用普通浏览器附加，或更新应用外壳。",
    ...
    "bgTasks.title": "后台任务",
    "bgTasks.open": "后台任务",
    "bgTasks.close": "关闭后台任务",
    "bgTasks.refresh": "刷新",
    "bgTasks.loading": "加载中…",
    "bgTasks.unavailable": "此后台任务面板不可用（会话不在运行、仅聊天会话，或未安装 pi-background-tasks 包）。",
    "bgTasks.empty": "还没有后台任务。用 bg_run 启动的任务会显示在这里。",
    "bgTasks.kill": "终止任务",
    "bgTasks.killConfirm": "终止？",
    "bgTasks.agentTask": "代理",
    "bgTasks.exitCode": "退出码",
    "bgTasks.output": "输出",
    "bgTasks.outputTruncated": "输出已截断（仅显示最后 50 KB）",
    "bgTasks.selectTask": "选择一个任务查看其输出",
    "bgTasks.notification.title": "后台任务已完成",
    "bgTasks.notification.body": "{name} · {status}",
    "bgTasks.status.running": "运行中",
    "bgTasks.status.completed": "已完成",
    "bgTasks.status.failed": "失败",
    "bgTasks.status.killed": "已终止",
  },
};
