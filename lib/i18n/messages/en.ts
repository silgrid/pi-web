...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.pinnedGroupCollapse": "Hide sessions for {path}",
    "sidebar.pinnedGroupNoSessions": "No sessions yet",
    "sidebar.addNew": "Add",
    "sidebar.renameDirectory": "Rename directory",
    ...
    "directoryPicker.entriesTitle": "Sidebar directory list",
    "directoryPicker.noEntries": "No directories added yet",
    "directoryPicker.entryName": "Display name",
    "directoryPicker.renameEntry": "Rename",
    "directoryPicker.removeEntry": "Remove from list",
    "directoryPicker.cannotRemoveLastEntry": "The last directory in the list cannot be removed",
    "directoryPicker.renamePathRequired": "Enter a directory path",
    "directoryPicker.renamePathDuplicate": "A directory with this path is already in the list",
    "directoryPicker.entryPath": "Directory path",
    "directoryPicker.newFolder": "New folder",
    "directoryPicker.folderName": "folder name",
    "directoryPicker.createFolder": "Create",
    "directoryPicker.mkdirConflict": "A folder with this name already exists",
    "directoryPicker.createFileConflict": "A file with this name already exists",
    "directoryPicker.newFile": "New file",
    "directoryPicker.fileName": "file name",
    "directoryPicker.fileCreated": "File created",
    "directoryPicker.showHidden": "Show hidden directories",
    "directoryPicker.pinDirectory": "Pin",
    "directoryPicker.rowNew": "New",
    "directoryPicker.rowNewFolderChoice": "Folder",
    "directoryPicker.rowNewFileChoice": "File",
    "directoryPicker.validation.required": "File name is required",
    "directoryPicker.validation.invalid": "Invalid file name",
    "directoryPicker.validation.dotSegment": "File names must not be \".\" or \"..\"",
    "directoryPicker.validation.pathSeparator": "File names must not contain a path",
    "directoryPicker.validation.tooLong": "File name is too long",
    ...
    "directoryPicker.fsManage.notDirectory": "Only directories can be renamed or deleted here",
    "directoryPicker.fsManage.outsideRegistrationPrefix": "This directory is protected and cannot be renamed or deleted",
    "directoryPicker.fsManage.pathInUse": "This directory is in use by an agent session",
    "directoryPicker.fsManage.confirmMismatch": "The typed name does not match the directory name",
    "directoryPicker.fsManage.targetExists": "A directory with this name already exists",
    "directoryPicker.fsManage.ioFailure": "The filesystem operation failed",
    ...
    "sidebar.explorerEmpty": "Add or select a directory to browse its files",
    "sidebar.explorerSectionExpand": "Show files for {path}",
    "sidebar.explorerSectionCollapse": "Hide files for {path}",
    ...
    "bgTasks.open": "Background tasks",
    "bgTasks.close": "Close background tasks",
    "bgTasks.refresh": "Refresh",
    "bgTasks.loading": "Loading…",
    "bgTasks.unavailable": "Background tasks are unavailable for this session (no live session, chat-only session, or the pi-background-tasks package is absent).",
    "bgTasks.empty": "No background tasks yet. Tasks started with bg_run appear here.",
    "bgTasks.kill": "Kill task",
    "bgTasks.killConfirm": "Kill?",
    "bgTasks.agentTask": "agent",
    "bgTasks.exitCode": "exit",
    "bgTasks.output": "Output",
    "bgTasks.outputTruncated": "Output truncated (showing last 50 KB)",
    "bgTasks.selectTask": "Select a task to view its output",
    "bgTasks.notification.title": "Background task finished",
    "bgTasks.notification.body": "{name} · {status}",
    "bgTasks.status.running": "Running",
    "bgTasks.status.completed": "Completed",
    "bgTasks.status.failed": "Failed",
    "bgTasks.status.killed": "Killed",
  },
};
