...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.chatContentWidthDescription": "設定訊息內容和輸入框的最大寬度，同時決定每個窗格的最小寬度（閱讀寬度加窗格內邊距）。",
    ...
    "sidebar.pinnedGroupCollapse": "隱藏 {path} 的工作階段",
    "sidebar.pinnedGroupNoSessions": "尚無工作階段",
    "sidebar.addNew": "新增",
    "sidebar.renameDirectory": "重新命名目錄",
    ...
    "directoryPicker.entriesTitle": "側邊欄目錄列表",
    "directoryPicker.noEntries": "尚未添加目錄",
    "directoryPicker.entryName": "顯示名稱",
    "directoryPicker.renameEntry": "重新命名",
    "directoryPicker.removeEntry": "從列表移除",
    "directoryPicker.cannotRemoveLastEntry": "無法移除列表中的最後一個目錄",
    "directoryPicker.renamePathRequired": "請輸入目錄路徑",
    "directoryPicker.renamePathDuplicate": "此路徑的目錄已在列表中",
    "directoryPicker.entryPath": "目錄路徑",
    "directoryPicker.newFolder": "新建資料夾",
    "directoryPicker.folderName": "資料夾名稱",
    "directoryPicker.createFolder": "建立",
    "directoryPicker.mkdirConflict": "同名資料夾已存在",
    "directoryPicker.createFileConflict": "已存在同名檔案",
    "directoryPicker.newFile": "新增檔案",
    "directoryPicker.fileName": "檔案名稱",
    "directoryPicker.fileCreated": "檔案已建立",
    "directoryPicker.showHidden": "顯示隱藏目錄",
    "directoryPicker.pinDirectory": "固定",
    "directoryPicker.rowNew": "新建",
    "directoryPicker.rowNewFolderChoice": "資料夾",
    "directoryPicker.rowNewFileChoice": "檔案",
    "directoryPicker.validation.required": "請輸入檔案名稱",
    "directoryPicker.validation.invalid": "檔案名稱無效",
    "directoryPicker.validation.dotSegment": "檔案名稱不能為 \".\" 或 \"..\"",
    "directoryPicker.validation.pathSeparator": "檔案名稱不能包含路徑",
    "directoryPicker.validation.tooLong": "檔案名稱過長",
    ...
    "directoryPicker.fsManage.notDirectory": "只能重新命名或刪除目錄",
    "directoryPicker.fsManage.outsideRegistrationPrefix": "此目錄受保護，無法重新命名或刪除",
    "directoryPicker.fsManage.pathInUse": "此目錄正由代理工作階段使用",
    "directoryPicker.fsManage.confirmMismatch": "輸入的名稱與目錄名稱不一致",
    "directoryPicker.fsManage.targetExists": "已存在同名目錄",
    "directoryPicker.fsManage.ioFailure": "檔案系統操作失敗",
    "sidebar.cancel": "取消",
    ...
    "sidebar.explorerEmpty": "添加或選擇目錄以瀏覽其檔案",
    "sidebar.explorerSectionExpand": "顯示 {path} 的檔案",
    "sidebar.explorerSectionCollapse": "隱藏 {path} 的檔案",
    "sidebar.loading": "載入中...",
    ...
    "chat.draftKeptTitle": "已保留目前草稿",
    "chat.draftKeptBody": "未載入歷史訊息，目前草稿保持不變。",
    ...
    "bgTasks.title": "背景工作",
    "bgTasks.open": "背景工作",
    "bgTasks.close": "關閉背景工作",
    "bgTasks.refresh": "重新整理",
    "bgTasks.loading": "載入中…",
    "bgTasks.unavailable": "此背景工作面板無法使用（工作階段未執行、純聊天工作階段，或未安裝 pi-background-tasks 套件）。",
    "bgTasks.empty": "還沒有背景工作。使用 bg_run 啟動的工作會顯示在這裡。",
    "bgTasks.kill": "終止工作",
    "bgTasks.killConfirm": "終止？",
    "bgTasks.agentTask": "代理",
    "bgTasks.exitCode": "結束代碼",
    "bgTasks.output": "輸出",
    "bgTasks.outputTruncated": "輸出已截斷（僅顯示最後 50 KB）",
    "bgTasks.selectTask": "選擇一個工作以查看其輸出",
    "bgTasks.notification.title": "背景工作已完成",
    "bgTasks.notification.body": "{name} · {status}",
    "bgTasks.status.running": "執行中",
    "bgTasks.status.completed": "已完成",
    "bgTasks.status.failed": "失敗",
    "bgTasks.status.killed": "已終止",
  },
};
